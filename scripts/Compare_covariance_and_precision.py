...
if __name__ == '__main__':
    ...
    for g,genome in enumerate(Genome):
        ...
        Complex = pd.read_csv(f'results/{genome}/TF_Complex.tsv',sep='\t',index_col=0)
        ...
        ax.set_title(f'{genome} {N_bin} bins')
    ...
    fig.set_size_inches([2*8,6])
    plt.tight_layout()
    fig.savefig(f'results/fig/scatter_covariance_precision_{N_bin}.pdf',dpi=150)
    plt.close(fig)
